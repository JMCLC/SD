...
class PythonClient(object):
    ...
    def add_person(self):
        ...
        person.educationDegree = input("Enter education degree: ")
    ...
    def list_all(self):
        """
        Client function to call the rpc for listAll
        """
        request = pb2.ListAllRequest()
        request.educationDegree = input("Enter education degree: ")
        try:
...
def print_person(person):
    ...
    print("  Education degree:", person.educationDegree)
...
def get_user_choice():
    ...
    print("[4] See a list of addresses with a specific education degree.")
    print("[q] Quit.")
